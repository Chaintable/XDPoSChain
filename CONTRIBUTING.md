...
This repository is a **fork**: upstream [XinFinOrg/XDPoSChain](https://github.com/XinFinOrg/XDPoSChain)
...
a general-purpose fork of XinFinOrg/XDPoSChain.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v2.6.8-ct.5`); a GitHub Release publishes the versioned images
